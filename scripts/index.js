...
const config = {
  birthdate: 'June 13, 2021',
  name: 'Verawati Eka Saputri'
};
...
x = setInterval(function() {
  ...
  let w = (c.width = window.innerWidth),
    ...
    hh = h / 2,
    opts = {
      strings: ['HAPPY', 'BIRTHDAY!', config.name, ' ', 'Semoga Panjang umur', 'sehat selalu,', 'dilancarkan rezekinya', 'serta kuliahnya', 'Makin rajin ibadahnya,', 'amin...'],
      charSize: 30,
      charSpacing: 26,
      lineHeight: 40,
